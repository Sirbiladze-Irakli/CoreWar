...
/*   Updated: 2020/02/10 17:38:39 by jormond-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			first(t_cw *corewar, t_ls *tmp, char *str)
{
	...
	if (g_op_tab[i].args[0] == '1')
		distrib(tmp, str, '1');
	else if (g_op_tab[i].args[0] == '2')
		distrib(tmp, str, '2');
	else if (g_op_tab[i].args[0] == '5')
		distrib(tmp, str, '5');
	else if (g_op_tab[i].args[0] == '6')
		distrib(tmp, str, '6');
}
...
void			second(t_cw *corewar, t_ls *tmp, char *str)
{
	...
	i = tab(corewar->lastinstr);
	if (g_op_tab[i].args[1] == '1')
		distrib(tmp, str, '1');
	else if (g_op_tab[i].args[1] == '3')
		distrib(tmp, str, '3');
	else if (g_op_tab[i].args[1] == '4')
		distrib(tmp, str, '4');
	else if (g_op_tab[i].args[1] == '6')
		distrib(tmp, str, '6');
}
...
void			third(t_cw *corewar, t_ls *tmp, char *str)
{
	...
	i = tab(corewar->lastinstr);
	if (g_op_tab[i].args[2] == '1')
		distrib(tmp, str, '1');
	else if (g_op_tab[i].args[2] == '3')
		distrib(tmp, str, '3');
}
